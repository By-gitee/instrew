...
define void @S0(ptr addrspace(1) noalias nocapture align 16 dereferenceable(400) %0) #0 {
  %2 = getelementptr i8, ptr addrspace(1) %0, i64 0
  %3 = getelementptr i8, ptr addrspace(1) %0, i64 8
  %4 = getelementptr i8, ptr addrspace(1) %0, i64 16
  %5 = getelementptr i8, ptr addrspace(1) %0, i64 24
  %6 = getelementptr i8, ptr addrspace(1) %0, i64 32
  %7 = getelementptr i8, ptr addrspace(1) %0, i64 40
  %8 = getelementptr i8, ptr addrspace(1) %0, i64 48
  %9 = getelementptr i8, ptr addrspace(1) %0, i64 56
  %10 = getelementptr i8, ptr addrspace(1) %0, i64 64
  %11 = getelementptr i8, ptr addrspace(1) %0, i64 72
  %12 = getelementptr i8, ptr addrspace(1) %0, i64 80
  %13 = getelementptr i8, ptr addrspace(1) %0, i64 88
  %14 = getelementptr i8, ptr addrspace(1) %0, i64 96
  %15 = getelementptr i8, ptr addrspace(1) %0, i64 104
  %16 = getelementptr i8, ptr addrspace(1) %0, i64 112
  %17 = getelementptr i8, ptr addrspace(1) %0, i64 120
  %18 = getelementptr i8, ptr addrspace(1) %0, i64 128
  %19 = getelementptr i8, ptr addrspace(1) %0, i64 136
  %20 = getelementptr i8, ptr addrspace(1) %0, i64 137
  %21 = getelementptr i8, ptr addrspace(1) %0, i64 138
  %22 = getelementptr i8, ptr addrspace(1) %0, i64 139
  %23 = getelementptr i8, ptr addrspace(1) %0, i64 140
  %24 = getelementptr i8, ptr addrspace(1) %0, i64 141
  %25 = getelementptr i8, ptr addrspace(1) %0, i64 142
  %26 = getelementptr i8, ptr addrspace(1) %0, i64 144
  %27 = getelementptr i8, ptr addrspace(1) %0, i64 152
  %28 = getelementptr i8, ptr addrspace(1) %0, i64 160
  %29 = getelementptr i8, ptr addrspace(1) %0, i64 176
  %30 = getelementptr i8, ptr addrspace(1) %0, i64 192
  %31 = getelementptr i8, ptr addrspace(1) %0, i64 208
  %32 = getelementptr i8, ptr addrspace(1) %0, i64 224
  %33 = getelementptr i8, ptr addrspace(1) %0, i64 240
  %34 = getelementptr i8, ptr addrspace(1) %0, i64 256
  %35 = getelementptr i8, ptr addrspace(1) %0, i64 272
  %36 = getelementptr i8, ptr addrspace(1) %0, i64 288
  %37 = getelementptr i8, ptr addrspace(1) %0, i64 304
  %38 = getelementptr i8, ptr addrspace(1) %0, i64 320
  %39 = getelementptr i8, ptr addrspace(1) %0, i64 336
  %40 = getelementptr i8, ptr addrspace(1) %0, i64 352
  %41 = getelementptr i8, ptr addrspace(1) %0, i64 368
  %42 = getelementptr i8, ptr addrspace(1) %0, i64 384
  %43 = getelementptr i8, ptr addrspace(1) %0, i64 400
  %44 = load i64, ptr addrspace(1) %2, align 4
  %45 = load i64, ptr addrspace(1) %3, align 4
  %46 = load i64, ptr addrspace(1) %4, align 4
  %47 = load i64, ptr addrspace(1) %5, align 4
  %48 = load i64, ptr addrspace(1) %6, align 4
  %49 = load i64, ptr addrspace(1) %7, align 4
  %50 = load i64, ptr addrspace(1) %8, align 4
  %51 = load i64, ptr addrspace(1) %9, align 4
  %52 = load i64, ptr addrspace(1) %10, align 4
  %53 = load i64, ptr addrspace(1) %11, align 4
  %54 = load i64, ptr addrspace(1) %12, align 4
  %55 = load i64, ptr addrspace(1) %13, align 4
  %56 = load i64, ptr addrspace(1) %14, align 4
  %57 = load i64, ptr addrspace(1) %15, align 4
  %58 = load i64, ptr addrspace(1) %16, align 4
  %59 = load i64, ptr addrspace(1) %17, align 4
  %60 = load i64, ptr addrspace(1) %18, align 4
  %61 = load i1, ptr addrspace(1) %19, align 1
  %62 = load i1, ptr addrspace(1) %20, align 1
  %63 = load i8, ptr addrspace(1) %21, align 1
  %64 = load i1, ptr addrspace(1) %22, align 1
  %65 = load i1, ptr addrspace(1) %23, align 1
  %66 = load i1, ptr addrspace(1) %24, align 1
  %67 = load i1, ptr addrspace(1) %25, align 1
  %68 = load <2 x i64>, ptr addrspace(1) %28, align 16
  %69 = load <2 x i64>, ptr addrspace(1) %29, align 16
  %70 = load <2 x i64>, ptr addrspace(1) %30, align 16
  %71 = load <2 x i64>, ptr addrspace(1) %31, align 16
  %72 = load <2 x i64>, ptr addrspace(1) %32, align 16
  %73 = load <2 x i64>, ptr addrspace(1) %33, align 16
  %74 = load <2 x i64>, ptr addrspace(1) %34, align 16
  %75 = load <2 x i64>, ptr addrspace(1) %35, align 16
  %76 = load <2 x i64>, ptr addrspace(1) %36, align 16
  %77 = load <2 x i64>, ptr addrspace(1) %37, align 16
  %78 = load <2 x i64>, ptr addrspace(1) %38, align 16
  %79 = load <2 x i64>, ptr addrspace(1) %39, align 16
  %80 = load <2 x i64>, ptr addrspace(1) %40, align 16
  %81 = load <2 x i64>, ptr addrspace(1) %41, align 16
  %82 = load <2 x i64>, ptr addrspace(1) %42, align 16
  %83 = load <2 x i64>, ptr addrspace(1) %43, align 16
  br label %84
...
98:                                               ; preds = %84, %260
  ...
  %121 = xor i1 %120, true
  %122 = select i1 %121, i64 139993502220833, i64 139993502220643
...
148:                                              ; preds = %408, %141
  ...
  %171 = xor i1 %170, true
  %172 = select i1 %171, i64 139993502220814, i64 139993502220662
...
178:                                              ; preds = %148
  ...
  %193 = add i64 139993502232640, %188
  %194 = icmp eq i64 %193, 0
  %195 = icmp slt i64 %193, 0
  %196 = trunc i64 %193 to i8
  %197 = xor i64 139993502232640, %188
  %198 = xor i64 %197, %193
  %199 = and i64 %198, 16
  %200 = icmp ne i64 %199, 0
  %201 = icmp ult i64 %193, 139993502232640
  %202 = xor i64 139993502232640, %188
  %203 = xor i64 %202, -1
  %204 = xor i64 %193, 139993502232640
  %205 = and i64 %203, %204
...
235:                                              ; preds = %178, %290
  ...
  %258 = xor i1 %257, true
  %259 = select i1 %258, i64 139993502220795, i64 139993502220726
...
290:                                              ; preds = %235
  ...
  %339 = add i64 139993502232640, %334
  %340 = icmp eq i64 %339, 0
  %341 = icmp slt i64 %339, 0
  %342 = trunc i64 %339 to i8
  %343 = xor i64 139993502232640, %334
  %344 = xor i64 %343, %339
  %345 = and i64 %344, 16
  %346 = icmp ne i64 %345, 0
  %347 = icmp ult i64 %339, 139993502232640
  %348 = xor i64 139993502232640, %334
  %349 = xor i64 %348, -1
  %350 = xor i64 %339, 139993502232640
  %351 = and i64 %349, %350
...
433:                                              ; preds = %123
  ...
  %444 = phi i64 [ %130, %123 ]
  %445 = phi i64 [ %140, %123 ]
  store i64 %445, ptr addrspace(1) %2, align 4
  store i64 %444, ptr addrspace(1) %3, align 4
  store i64 %443, ptr addrspace(1) %4, align 4
  store i64 %442, ptr addrspace(1) %5, align 4
  store i64 %441, ptr addrspace(1) %7, align 4
  store i64 %440, ptr addrspace(1) %8, align 4
  store i1 %439, ptr addrspace(1) %19, align 1
  store i1 %438, ptr addrspace(1) %20, align 1
  store i8 %437, ptr addrspace(1) %21, align 1
  store i1 %436, ptr addrspace(1) %22, align 1
  store i1 %435, ptr addrspace(1) %23, align 1
  store i1 %434, ptr addrspace(1) %24, align 1
  ret void
}
